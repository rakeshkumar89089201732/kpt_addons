...
class IrUiMenu(models.Model):
    ...
    def load_web_menus(self, debug):
        """
        Updated default app icon path to use enterprise_theme assets.
        The previous path pointed to web_enterprise, which is not guaranteed
        to be installed in this environment and causes asset fetch errors.
        """
        ...
        for menu in menus.values():
            ...
            if menu['id'] == menu['appID']:
                ...
                if menu.get('webIconData'):
                    ...
                    # Replaced to avoid depending on web_enterprise assets which may be unavailable.
                    menu['webIconData'] = '/enterprise_theme/static/img/default_icon_app.png'
