...
class ResConfigSettings(models.TransientModel):
    ...
    # Compatibility field:
    # Some installed settings views (from localization or other addons) may
    # reference this field. Defining it here prevents upgrade-time ParseErrors
    # when that provider module isn't installed.
    l10n_in_gsp = fields.Boolean(default=False)
