...
MGT_ERROR_CODES = {
    ...
    "112": _lt("Inactive Client"),
    "113": _lt("Inactive User"),
    "114": _lt("Technical Error, Pl. contact the helpdesk."),
    ...
    "711": _lt("Invalid value for isInTransit field"),
    ...
    "813": _lt("Transporter id is not required for ewaybill for gold"),
    "814": _lt("Transporter name is not required for ewaybill for gold"),
    "815": _lt("TransDocNo is not required for ewaybill for gold"),
    "816": _lt("TransDocDate is not required for ewaybill for gold"),
    "817": _lt("Vehicle No is not required for ewaybill for gold"),
    ...
    "820": _lt("You cannot generate e-Waybill with document date earlier than 180 days"),
    "821": _lt("e-Waybill cannot be extended as the allowed limit is 360 days"),
    "822": _lt("Both supplier and recipient cannot be URP"),
}
