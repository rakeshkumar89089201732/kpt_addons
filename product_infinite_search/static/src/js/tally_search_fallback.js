...
Many2XAutocomplete.prototype.loadOptionsSource = async function (request) {
    ...
    // Backend returns [[id, display_name], ...] tuples
    ...
    const canCreateEdit = this.activeActions?.createEdit !== false && 
    ...
    // Create and edit option - always show if field allows creation
