...
class ProductTemplate(models.Model):
    ...
    def _compute_display_name(self):
        """Override display_name to show only product name without internal reference.
        
        Standard Odoo shows: [INTERNAL_REF] Product Name
        This override shows: Product Name
        """
