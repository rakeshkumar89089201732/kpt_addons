/** @odoo-module **/
odoo.define('ks_dashboard_ninja.ks_to_do_dashboard_filter', [], function () {
    "use strict";
    // Legacy To-Do dashboard integration is disabled for Odoo 17.
    return {};
});
...
// In Odoo 17 the legacy dashboard class may not exist. Implement as a no-op
// to prevent loader errors; integrate with the new dashboard later if needed.
var _t = core._t;
var QWeb = core.qweb;

return {
    // placeholder: to-do dashboard integration is disabled in this build
};
});
*** End Patch
