odoo.define('ks_dashboard_ninja.import_button', [
    'web.core',
    'web.Sidebar',
    'web.ListController',
    'web.framework',
    'web.Dialog'
], function (core, Sidebar, ListController, framework, Dialog) {
            ...
            if (this.modelName == "ks_dashboard_ninja.board") {
                if (this.hasSidebar) {
                    ...
                    this.sidebar = new Sidebar(this, {
                        ...
                        actions: Object.assign({}, this.toolbarActions, { other: other }),
                    });
