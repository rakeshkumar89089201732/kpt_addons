...
class KsDashboardExport(http.Controller):
    ...
    def filename(self, base):
        """ Return filename for the exported file """
        raise NotImplementedError()

    def from_data(self, data):
        """ Convert data to the export format """
        raise NotImplementedError()
...
class KsDashboardJsonExport(KsDashboardExport):
...
class KsItemJsonExport(KsDashboardExport):
